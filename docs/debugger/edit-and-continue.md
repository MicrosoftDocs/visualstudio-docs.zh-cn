---
title: 在 Visual Studio 调试时编辑代码并继续 |Microsoft Docs
ms.custom: ''
ms.date: 05/31/2017
...
ms.locfileid: "44284008"
---
# <a name="edit-code-and-continue-debugging-in-visual-studio-c-vb-c"></a>在Visual Studio 调试时编辑代码并继续 (C#、 VB、 c + +）
